...
flags.DEFINE_string('lth_prediction_result_dir', '',
                    'Prediction result dir.')
flags.DEFINE_bool('lth_no_pruning', False, 'No pruning.')
...
def main(unused_argv):
  ...
  if FLAGS.mode == 'eval':
    ...
    with tf.gfile.Open(os.path.join(FLAGS.lth_prediction_result_dir, 'predictions'), 'wb') as f:
