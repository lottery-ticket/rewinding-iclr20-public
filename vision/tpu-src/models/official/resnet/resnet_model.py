...
def conv2d_fixed_padding(inputs, filters, kernel_size, strides,
                         data_format='channels_first', projection=False):
  ...
  base_name = ('conv_{layer_idx}' if not projection else 'proj_{layer_idx}_{proj_idx}').format(
...
def residual_block(inputs, filters, is_training, strides,
  ...
  if use_projection:
    ...
    shortcut = conv2d_fixed_padding(
        ...
        data_format=data_format, projection=True)
