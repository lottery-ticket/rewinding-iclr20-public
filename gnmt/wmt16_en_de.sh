...
if [ ! -d "${OUTPUT_DIR}/mosesdecoder" ]; then
  ...
  pushd "${OUTPUT_DIR}/mosesdecoder"
  git checkout 5b9a6da9a4065b776d1dffedbd847be565c436ef
  popd
fi
...
if [ ! -d "${OUTPUT_DIR}/subword-nmt" ]; then
  ...
  pushd "${OUTPUT_DIR}/subword-nmt"
  git checkout 3d28265d779e9c6cbb39b41ba54b2054aa435005
  popd
fi
