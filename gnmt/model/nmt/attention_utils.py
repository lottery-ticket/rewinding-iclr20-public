...
def _bahdanau_score(processed_query, keys, normalize):
  ...
  v = variable_scope.get_variable(lottery.weight_name_of_base_name("attention_v"), [num_units], dtype=dtype)
  v_m = variable_scope.get_variable(lottery.mask_name_of_base_name("attention_v"), [num_units], dtype=dtype, trainable=False, initializer=tf.initializers.ones())
  v = tf.math.multiply(v, v_m)
  ...
  if normalize:
    ...
    b = variable_scope.get_variable(
        lottery.weight_name_of_base_name("attention_b"), [num_units], dtype=dtype,
        initializer=init_ops.zeros_initializer())
    b_m = variable_scope.get_variable(
      lottery.mask_name_of_base_name("attention_b"), [num_units], dtype=dtype,
      trainable=False, initializer=tf.initializers.ones()
    )
    b = tf.math.multiply(b, b_m)
...
class BahdanauAttention(_BaseAttentionMechanism):
  ...
  def __init__(self,
    ...
    super(BahdanauAttention, self).__init__(
        query_layer=model_helper.Dense(
